...
<div>
 ...
 <div class="col-md-12">
    <input type="hidden" value="<?php echo $_SESSION['S_USER'] ?>" id="idUs">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-lg-2">
                    ...
                    <select class="js-example-basic-single  form form-control combo" name="state" id="cmb_jornada_matricula">                    
                    </select> 
                </div> 
                <div class="col-lg-2">
  ...
  <div class="modal-dialog fade in" role="document" style="width: 70%;">
    ...
    <script type="text/javascript">
       ...
       $("#cmb_sede_matricula").change(function(){
            ...
            listar_combo_programa_profe(idsede);
            //alert(' id ' +idsede);
        })
    </script>